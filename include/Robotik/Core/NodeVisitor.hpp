 ...
 * @brief Visitor pattern for traversing the node hierarchy.
 *
...
//!
//! This visitor pattern allows operations on the node hierarchy without
...
protected:
    ...
    //! \brief Current depth in the tree hierarchy
    size_t m_depth = 0;
...
// ****************************************************************************
//! \brief Const visitor for read-only traversal of the node hierarchy.
//!
