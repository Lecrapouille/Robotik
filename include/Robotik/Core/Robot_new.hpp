...
public:
    ...
    // ------------------------------------------------------------------------
    explicit Robot_new(Hierarchy const& p_hierarchy);
    ...
    // ------------------------------------------------------------------------
    //! \brief Create a State object with proper dimensions for this robot.
    //!
    //! This is a convenience method to create a State with the correct
    //! number of joints and links for this robot model.
    //!
    //! \return A properly sized State object initialized to zero.
    // ------------------------------------------------------------------------
    ...
    // ------------------------------------------------------------------------
    Jacobian const& computeJacobian(State& p_state,
...
private:
    ...
    //! \brief Reference to the robot's kinematic hierarchy (model)
