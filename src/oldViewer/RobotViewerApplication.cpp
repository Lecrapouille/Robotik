    ...
    std::string const& p_look_at_joint_name)
{
    ...
    if (m_camera_target)
    {
        ...
        m_viewer.cameraView(
            OpenGLWindow::CameraViewType::SIDE,
...
void RobotViewerApplication::handleInput(int key, int /* action */)
{
    ...
    static const std::map<int, OpenGLWindow::CameraViewType> camera_keys = {
        { GLFW_KEY_1, OpenGLWindow::CameraViewType::PERSPECTIVE },
        { GLFW_KEY_2, OpenGLWindow::CameraViewType::TOP },
        { GLFW_KEY_3, OpenGLWindow::CameraViewType::FRONT },
        { GLFW_KEY_4, OpenGLWindow::CameraViewType::SIDE },
        { GLFW_KEY_5, OpenGLWindow::CameraViewType::ISOMETRIC }
    };
