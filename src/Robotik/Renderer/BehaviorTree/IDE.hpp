...
// ****************************************************************************
class IDE: public robotik::bt::BTApplication
{
...
public:
    ...
    struct Node
    {
        ...
        std::shared_ptr<robotik::bt::Node> bt_node;
...
private: // Tree conversion (internal)
    ...
    void buildNodesFromTree(robotik::bt::Node& p_root);
    int buildNodesFromTreeRecursive(robotik::bt::Node& p_node, ID p_parent_id);
...
protected:
    ...
    std::shared_ptr<robotik::bt::Blackboard> m_blackboard;
