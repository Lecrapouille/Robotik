...
public:
    ...
    //! \param p_index Index of the joint in the blueprint to access it from a
    //! std::vector<Joint>.
    ...
    // ------------------------------------------------------------------------
    //! \brief Get the joint's index in the blueprint.
    //! \return The joint's index in the blueprint.
    // ------------------------------------------------------------------------
    ...
    // ------------------------------------------------------------------------
    //! \brief Set the joint's index in the blueprint.
    //!
    //! This method is called by Blueprint::cacheBlueprintTree() to assign
...
private:
    ...
    Joint::Type m_type;
    //! \brief Index of the joint in the blueprint.
    size_t m_index = 0;
